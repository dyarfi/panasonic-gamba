...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        <meta charset="utf-8" />
        <title>Panasonic Admin | Login Page</title>
        ...
        <link href="<?php echo base_url()?>assets/grocery_crud/assets/css/pages/login.css" rel="stylesheet" type="text/css"/>
    ...
    <body class="login">
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="form-vertical login-form" method="post" action="<?php echo base_url() ?>admin/home/do_login">
        ...
        <!-- BEGIN CORE PLUGINS -->   <script src="<?php echo base_url()?>assets/grocery_crud/assets/plugins/jquery-1.10.1.min.js" type="text/javascript"></script>
        ...
        <script src="<?php echo base_url()?>assets/grocery_crud/assets/plugins/jquery-ui/jquery-ui-1.10.1.custom.min.js" type="text/javascript"></script>      
        ...
        <script src="<?php echo base_url()?>assets/grocery_crud/assets/plugins/jquery-validation/dist/jquery.validate.min.js" type="text/javascript"></script>	
        <script type="text/javascript" src="<?php echo base_url()?>assets/grocery_crud/assets/plugins/select2/select2.min.js"></script>     
        <!-- END PAGE LEVEL PLUGINS -->
        <!-- BEGIN PAGE LEVEL SCRIPTS -->
        <script src="<?php echo base_url()?>assets/grocery_crud/assets/scripts/app.js" type="text/javascript"></script>
        <script src="<?php echo base_url()?>assets/grocery_crud/assets/scripts/login.js" type="text/javascript"></script> 
