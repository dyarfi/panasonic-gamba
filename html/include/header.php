...
<div class="container">
    ...
    <div class="navbar navbar-header pull-right">
        <a href="home.php"><img class="navbar-brand"  src="assets/img/logo.png" alt=""/></a>
    </div>
          <ul class="nav navbar-nav pull-right">
            <li class="active"><a href="home.php">HOME</a></li>
            <li><a href="mechanism.php">MECHANISM</a></li>
            <li><a href="dream_team.php">MY DREAM TEAM</a></li>
          </ul>
    </nav>
